...
class ViewController: UIViewController {
    ...
    @objc func floatingButtonDidTouched(_ sender: UITapGestureRecognizer) {
        if !floatingButtonIsActive {
            UIView.animate(withDuration: 1.0, delay: 0.0, usingSpringWithDamping: 0.6, initialSpringVelocity: 5, options: UIView.AnimationOptions(), animations: {
                ...
                self.floatingButtonImageView.transform = CGAffineTransform(rotationAngle: CGFloat(Double.pi / 4))
            ...
            UIView.animate(withDuration: 0.4, delay: 0.0, usingSpringWithDamping: 0.7, initialSpringVelocity: 5, options: UIView.AnimationOptions(), animations: {
                ...
                UIView.animate(withDuration: 0.4, delay: 0.0, usingSpringWithDamping: 0.7, initialSpringVelocity: 5, options: UIView.AnimationOptions(), animations: {
                    ...
                    UIView.animate(withDuration: 0.4, delay: 0.0, usingSpringWithDamping: 0.7, initialSpringVelocity: 5, options: UIView.AnimationOptions(), animations: {
                        ...
                        UIView.animate(withDuration: 0.4, delay: 0.0, usingSpringWithDamping: 0.4, initialSpringVelocity: 5, options: UIView.AnimationOptions(), animations: {
